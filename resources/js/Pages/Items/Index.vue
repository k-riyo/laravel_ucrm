                                    ...
                                    <table class="table-auto w-full text-left whitespace-no-wrap">
                                        ...
                                        <tbody>
                                            <tr v-for="item in items" :key="item.id">
                                                <td class="border-t-2 border-gray-200 px-4 py-3 px-4 py-3">{{item.id}}</td>
                                                <td class="border-t-2 border-gray-200 px-4 py-3 px-4 py-3">{{item.name}}</td>
                                                <td class="border-t-2 border-gray-200 px-4 py-3 px-4 py-3">{{item.price}}</td>
                                                <td class="border-t-2 border-gray-200 px-4 py-3 px-4 py-3 text-lg text-gray-900">
